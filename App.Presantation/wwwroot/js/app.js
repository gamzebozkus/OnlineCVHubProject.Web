...
let CvNameSurnameElem = mainForm.CvNameSurname,
...
const getUserInputs = () => {
    ...
    CvNameSurnameElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.TEXT, 'First Name'));
    ...
    PhoneNumberElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.PhoneNumber, 'Phone Number'));
    ...
    return {
        CvNameSurname: CvNameSurnameElem.value,
...
const displayCV = (userData) => {
    nameDsp.innerHTML = userData.CvNameSurname + " " + userData.middlename;
